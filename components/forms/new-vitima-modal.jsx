...
// Cores definidas diretamente no arquivo
const appColors = {
  darkTeal: '#2C7A7B',
  steelBlue: '#4682B4',
  warmBeige: '#F5DEB3',
...
export default function ModalNovaVitima({ visible, onClose, casoId, onVitimaCreated }) {
  ...
  const handleCreateVitima = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${API_URL}/api/vitimas`, dadosEnvio, {
        headers: {
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            <Pressable style={styles.closeButton} onPress={handleClose} disabled={loading}>
          ...
          >
            ...
            <View style={styles.section}>
              ...
              <View style={styles.inputGroup}>
                <Text style={styles.label}>NIC (Número de Identificação Criminal) *</Text>
                <TextInput
                  style={styles.input}
                  value={formData.nic}
            ...
            <View style={styles.warningBox}>
              <MaterialIcons name="info" size={20} color={appColors.warmBeige} />
              <Text style={styles.warningText}>
                Os campos marcados com * são obrigatórios. O odontograma será inicializado
                automaticamente.
              </Text>
            </View>
          </ScrollView>
...
const styles = StyleSheet.create({
  ...
  warningBox: {
    ...
    borderRadius: 8,
    borderLeftWidth: 4,
    borderLeftColor: appColors.warmBeige,
    marginTop: 8
  },
  warningText: {
    flex: 1,
